...
export const SEARCH_INDEX: SearchEntry[] = [
  { title: "CRM Console", to: "/app/crm", category: "Product", description: "Sales pipeline, KPIs and lead velocity inside the console.", keywords: ["console", "pipeline", "app"] },
  { title: "Leads Inbox", to: "/app/leads", category: "Product", description: "Triage inbound leads and assign owners.", keywords: ["leads", "inbox"] },
  { title: "Property Marketplace", to: "/app/marketplace", category: "Product", description: "Browse verified inventory with AI investment scores.", keywords: ["properties", "listings", "deals"] },
  { title: "AI Voice Cockpit", to: "/app/voice", category: "Product", description: "Live call cockpit with realtime waveforms.", keywords: ["calls", "voice", "cockpit"] },
  { title: "Marketing Center", to: "/app/marketing", category: "Product", description: "Campaigns, journeys and attribution.", keywords: ["marketing", "campaigns"] },
  { title: "Intelligence Dashboard", to: "/app/bi", category: "Product", description: "Live BI across CRM, marketplace and voice.", keywords: ["bi", "dashboard", "analytics"] },
  { title: "Executive Command", to: "/app/command", category: "Product", description: "Executive health dial and forecast suite.", keywords: ["command", "forecast", "kie"] },
  { title: "AI Copilot", to: "/app/copilot", category: "Product", description: "Ask questions across your workspace.", keywords: ["copilot", "chat", "ai"] },
  { title: "Document Chat", to: "/app/docchat", category: "Product", description: "RAG chat over uploaded documents.", keywords: ["docs", "rag", "chat"] },
  { title: "Recommendations", to: "/app/recommendations", category: "Product", description: "AI recommendations with impact scores.", keywords: ["recommendations"] },
  { title: "Deal Rooms", to: "/app/dealrooms", category: "Product", description: "AI-scored deal rooms.", keywords: ["deals", "rooms"] },
  { title: "Risk Center", to: "/app/risk", category: "Product", description: "Portfolio risk signals.", keywords: ["risk"] },
  { title: "Market Intelligence", to: "/app/market", category: "Product", description: "Market signals and comps.", keywords: ["market"] },
  { title: "Inventory Intelligence", to: "/app/inventory", category: "Product", description: "Inventory analytics and drilldowns.", keywords: ["inventory"] },
  { title: "Collections AI", to: "/app/collections", category: "Product", description: "Collections prioritization.", keywords: ["collections"] },
  { title: "Sales Intelligence", to: "/app/salesintel", category: "Product", description: "Sales performance intelligence.", keywords: ["sales"] },
  { title: "Intelligence Graph", to: "/app/graph", category: "Product", description: "Relationship graph across entities.", keywords: ["graph"] },
  { title: "Documents", to: "/app/documents", category: "Product", description: "Document intelligence workspace.", keywords: ["documents"] },
  { title: "Governance", to: "/app/governance", category: "Product", description: "Policy, audit and controls.", keywords: ["governance", "audit"] },
  { title: "Branding Settings", to: "/app/settings/branding", category: "Product", description: "Per-tenant logo and theme.", keywords: ["branding", "logo"] },
  { title: "Users & Roles", to: "/app/users", category: "Product", description: "Manage members and RBAC roles.", keywords: ["users", "roles", "rbac"] },
