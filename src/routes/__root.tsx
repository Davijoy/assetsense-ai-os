...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Sentinel Fort Group" },
      ...
      { name: "twitter:site", content: "@SentinelFort" },
      { name: "twitter:title", content: "Sentinel Fort Group — Where Real Estate Meets Intelligence" },
