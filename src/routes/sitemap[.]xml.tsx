    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/resources/documentation", changefreq: "weekly", priority: "0.8" },
          { path: "/resources/knowledge-base", changefreq: "weekly", priority: "0.7" },
          { path: "/resources/blog", changefreq: "weekly", priority: "0.8" },
          { path: "/resources/api", changefreq: "monthly", priority: "0.7" },
          { path: "/resources/release-notes", changefreq: "weekly", priority: "0.7" },
          { path: "/resources/case-studies", changefreq: "monthly", priority: "0.7" },
          { path: "/resources/customers", changefreq: "monthly", priority: "0.7" },
          { path: "/resources/help", changefreq: "monthly", priority: "0.6" },
          { path: "/resources/community", changefreq: "monthly", priority: "0.6" },
          { path: "/resources/status", changefreq: "daily", priority: "0.5" },
