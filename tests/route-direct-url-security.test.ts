...
describe("Direct URL Route Security & Route Guards", () => {
  const protectedRoutes = [
    ...
    { route: "/app/salesintel", allowed: ["admin", "manager", "builder", "developer"], forbidden: ["agent", "viewer"] },
    { route: "/app/copilot", allowed: ["admin", "manager", "builder", "developer"], forbidden: ["agent", "viewer"] },
    { route: "/app/docchat", allowed: ["admin", "manager", "builder", "developer"], forbidden: ["agent", "viewer"] },
